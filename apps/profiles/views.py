...
# представление возвращает список всех заказов, принадлежащих конкретному пользователю
...
# представление возвращает список элементов конкретного заказа (товаров внутри заказа)
