...
class User(AbstractBaseUser, IsDeletedModel, PermissionsMixin):
    ...
    avatar = models.ImageField(upload_to="avatars/", null=True, default='avatar/default.jpg')

    is_staff = models.BooleanField(default=False)
    is_active = models.BooleanField(default=True)
    account_type = models.CharField(max_length=25, choices=ACCOUNT_TYPE_CHOICES, default="BUYER")
